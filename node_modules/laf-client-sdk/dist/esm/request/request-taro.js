 ...
 * Taro 环境请求类
 */
var TaroRequest = /** @class */ (function (_super) {
    __extends(TaroRequest, _super);
    function TaroRequest(config) {
     ...
     * @returns
     */
    TaroRequest.prototype.request = function (url, data, _options) {
        var _a;
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, taro.request(options)];
                    case 1:
                        res = _b.sent();
                        return [2 /*return*/, res];
                }
